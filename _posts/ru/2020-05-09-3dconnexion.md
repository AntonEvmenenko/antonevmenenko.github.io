...
### Содержание
1. [Вступление](#intro)
1. [Манипулятор 3DConnexion?](#what_is_3dconnexion)
1. [Вертикальная мышь?](#what_is_vertical_mice)
1. [Прототипирование](#prototyping)
1. [3D сканирование](#3d_scanning)
1. [Версия 0](#version_0)
1. [Устранение проблем версии 0](#version_0_fix_problems)
1. [Версия 1](#version_1)
1. [Рендеры финальной версии](#renders)
...
### Манипулятор 3DConnexion? <a name="what_is_3dconnexion"></a>
...
### Вертикальная мышь? <a name="what_is_vertical_mice"></a>
